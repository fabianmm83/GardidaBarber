"""Reset models relationships

Revision ID: fefe0ccdf1cf
Revises: 
Create Date: 2025-04-29 23:30:52.446732
...
def upgrade():
    ...
    sa.Column('subtotal', sa.Float(), nullable=False),
    sa.Column('descuento_item', sa.Float(), nullable=True),
